...
class TokenBrowser:
    ...
    # 分辨率池
    # Max height 1080 (no QHD/4K vertical) so viewports stay within typical 1080p-class displays.
    RESOLUTIONS = [
        (1920, 1080), (1366, 768), (1536, 864), (1600, 900), (1280, 720), (1360, 768),
                ...
                for attempt in range(max_retries):
                    try:
                        ...
                        if attempt >= max_retries - 1:
                            debug_logger.log_recaptcha_browser_error(
                                f"empty token from enterprise.execute after {max_retries} attempts",
                        ...
                        debug_logger.log_recaptcha_execution_error(error_message[:500])
